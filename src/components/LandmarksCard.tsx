...
const LandmarksCard = ({ id, name, photo, description, location = "Leyte" }: LandmarksInfo) => {
    return (
        <Link to={`/landmarks/${id}`} className="group md:w-[22em] w-full rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 bg-white hover:-translate-y-1 block">
